...
describe(code, function () {
    ...
    describe('#label', function () {
        it('should behave properly with some text', function () {
            ...
            assert.equal(instance.getLabel(), '01234500006');
        ...
        it('should behave properly with other text', function () {
            ...
            assert.equal(instance.getLabel(), '07820000901');
    ...
    describe('#maxSize', function () {
        ...
        describe('with no label', function () {
            it('should work with scale=1', function () {
                ...
                instance.parse(defaultText);
                assert.deepEqual([(7 * defaultText.length + 3 + 5 + 1) * scale, (30) * scale], instance.getDimension(0, 0));
            });
            ...
            it('should work with scale=2 and extra positioning', function () {
                ...
                instance.setThickness(30);
                instance.parse(defaultText);
                assert.deepEqual([(7 * defaultText.length + 3 + 5 + 1 + left) * scale, (30 + top) * scale], instance.getDimension(left, top));
            });
            ...
            it('should work with scale=2 and extra positioning and offset', function () {
                ...
                instance.parse(defaultText);
                assert.deepEqual([(7 * defaultText.length + 3 + 5 + 1 + left + offsetX) * scale, (30 + top + offsetY) * scale], instance.getDimension(left, top));
            });
        });
        ...
        describe('with one label', function () {
            it('should work with scale=1', function () {
                ...
                // We should test Y
                assert.equal((7 * defaultText.length + 3 + 5 + 1) * scale + getLeftLabelSize()[0] + getRightLabelSize()[0], instance.getDimension(0, 0)[0]);
            });

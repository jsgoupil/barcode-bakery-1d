...
describe(code, function () {
    ...
    describe('#maxSize', function () {
        var textLength = (6 + 2) /*1*/ + (6 + 2) /*2*/ + (6 + 2) /*3*/ + (6 + 2) /*4*/ + (6 + 2)/*5*/,
            checksumLength = (6 + 2);
        ...
        describe('with no label', function () {
            it('should work with scale=1', function () {
                ...
                instance.parse(defaultText);
                assert.deepEqual([(textLength + 8 + checksumLength + 7) * scale, (30) * scale], instance.getDimension(0, 0));
            });
            ...
            it('should work with scale=2 and extra positioning', function () {
                ...
                instance.setThickness(30);
                instance.parse(defaultText);
                assert.deepEqual([(textLength + 8 + checksumLength + 7 + left) * scale, (30 + top) * scale], instance.getDimension(left, top));
            });
            ...
            it('should work with scale=2 and extra positioning and offset', function () {
                ...
                instance.parse(defaultText);
                assert.deepEqual([(textLength + 8 + checksumLength + 7 + left + offsetX) * scale, (30 + top + offsetY) * scale], instance.getDimension(left, top));
            });
        });
        ...
        describe('with one label', function () {
            it('should work with scale=1', function () {
                ...
                assert.deepEqual([(textLength + 8 + checksumLength + 7) * scale, (30) * scale + dimension[1]], instance.getDimension(0, 0));
            });
